...
intializue some internal objects based on the given arguments. For this
purpose there is the argument list at object creation checked for the presence
of a function called `init` which is then executed with the argument self. Here an example.
...
But the latter approach would require two function calls by the user.
